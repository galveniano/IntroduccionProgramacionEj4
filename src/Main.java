...
public class Main {
    public static void main(String[] args) {
        ...
        // Crea un bucle While, este bucle tendrá que
        // tener como condición que la variable numeroWhile sea inferior a 3, el bloque de código que tendrá el bucle deberá:
       ...
       //  También habrá que poner un default para cuando el valor de la variable no sea una estación.
        ...
        switch (estacion){
            ...
            case "Primavera":
                ...
                break;
            default:
                System.out.println("La estación actual es desconocida.");
                break;
